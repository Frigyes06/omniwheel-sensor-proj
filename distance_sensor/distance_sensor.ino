#define trigPin 10
#define echoForward A0
#define echoLeft A1
#define echoBackward A2
#define echoRight A3
...
void loop() {
  //1 szenzor
   ...
   elore.tmp1=getDistance(echoForward);
  ...
  //2 szenzor
   ...
   hatra.tmp1=getDistance(echoBackward);
  ...
  //3 szenzor
   ...
   jobbra.tmp1=getDistance(echoRight);
  ...
  //4 szenzor
   ...
   balra.tmp1=getDistance(echoLeft);
